    ...
    >
      <div className="relative w-full">
        ...
        <div className="flex justify-end gap-2 mr-10 mt-2">
          <button
            className="relative z-40 h-10 w-10 rounded-full bg-slate-100 dark:bg-zinc-800 flex items-center justify-center disabled:opacity-40 border border-slate-200 dark:border-zinc-700 transition-colors"
            onClick={scrollLeft}
          ...
          >
            <ArrowRight className="h-5 w-5 text-slate-700 dark:text-zinc-300" />
          </button>
        </div>
      </div>
    </CarouselContext.Provider>
...
export const Card = ({
      ...
      {open && (
        <div className="fixed inset-0 z-[100000] h-full w-full overflow-y-auto overscroll-contain flex justify-center px-4 py-8 sm:py-12">
          ...
          <motion.div
            ...
            ref={containerRef}
            className="relative z-[100001] my-auto w-full max-w-4xl h-fit bg-white dark:bg-[#111113] p-5 sm:p-8 md:p-10 rounded-3xl font-sans border border-slate-200 dark:border-zinc-800 shadow-2xl"
          >
            <button
  ...
  return (
    <>
      ...
      <motion.button
        onClick={handleOpen}
        className="rounded-3xl bg-zinc-900 h-96 w-64 sm:h-[28rem] sm:w-72 md:h-[40rem] md:w-96 overflow-hidden flex flex-col items-start justify-between relative z-10 text-left border border-zinc-800/80 group shadow-lg hover:shadow-2xl transition-all duration-300"
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-zinc-950/90 via-zinc-950/70 to-zinc-950/95 z-10 pointer-events-none" />
        ...
        {isDesktopApp ? (
          <div className="relative z-20 w-[90%] mx-auto mt-auto mb-5 sm:mb-6 md:mb-8 rounded-2xl overflow-hidden border border-white/20 bg-zinc-950 shadow-2xl group-hover:scale-[1.03] group-hover:-translate-y-1 transition-all duration-500">
          ...
          <div className="relative z-20 w-[82%] max-w-[240px] mx-auto mt-auto mb-5 sm:mb-6 md:mb-8 rounded-3xl overflow-hidden border-4 border-zinc-800 bg-zinc-950 shadow-2xl group-hover:scale-[1.03] group-hover:-translate-y-1 transition-all duration-500">
            {/* Mobile Portrait View */}
            <div className="relative aspect-[9/18] w-full overflow-hidden bg-zinc-900">
              <Image
                src={card.src}
                alt={card.title}
                fill
