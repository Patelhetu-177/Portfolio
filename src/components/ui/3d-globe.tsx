...
function Marker({
  ...
  return (
    <group ref={groupRef} visible={isVisible}>
      ...
      {/* Circular image and text beside it at the top */}
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          <div
            ...
            onClick={handleClick}
          >
            {/* Ultra-sharp Avatar Circle */}
            <div
              className={cn(
                "w-7 h-7 rounded-full overflow-hidden border-2 border-white/90 shadow-md shrink-0 bg-slate-900 transition-transform duration-200",
                hovered && "scale-110 ring-2 ring-sky-400"
              )}
            >
              <img
                src={marker.src}
                alt={marker.label || "Hetu Patel"}
  ...
  return (
    <Html center>
      <div className="flex shrink-0 flex-col items-center gap-3">
        <span className="inline-block shrink-0 text-xs font-mono text-slate-400 animate-pulse">
          Loading 3D globe...
        </span>
      </div>
    </Html>
...
export function Globe3D({
  ...
  return (
    <div className={cn("relative h-[360px] sm:h-[420px] w-full", className)}>
      <Canvas
        gl={{
          antialias: true,
          alpha: true,
