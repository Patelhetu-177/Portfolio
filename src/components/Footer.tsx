...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-slate-200/90 dark:border-zinc-800/80 bg-white/80 dark:bg-[#09090b]/80 backdrop-blur-md py-12">
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Quick Nav */}
          <div className="flex flex-wrap justify-center gap-6 text-xs font-semibold text-slate-600 dark:text-zinc-400">
            <a href="#about" className="hover:text-sky-500 transition-colors">
              About
            </a>
            <a href="#stats" className="hover:text-sky-500 transition-colors">
              Stats
            </a>
          ...
          <button
            ...
            className="p-3 rounded-full bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-zinc-300 hover:bg-sky-500 hover:text-white dark:hover:bg-sky-500 dark:hover:text-white transition-colors border border-slate-200 dark:border-zinc-700"
          >
